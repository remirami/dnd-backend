...
def test_character_creation_with_racial_features():
    ...
    # Clean up existing test character
    Character.objects.filter(name='Test Elf Fighter').delete()
...
def test_subclass_selection():
    ...
    # Clean up existing test character
    Character.objects.filter(name='Test Champion Fighter').delete()
...
def test_level_up_with_subclass():
    ...
    # Clean up existing test character
    Character.objects.filter(name='Test Battle Master').delete()
